...
export const CharacterInfo = () => {
  ...
  const { data, loading, error } = useQuery<CharacterData>(CHARACTER, {
    variables: { id },
  });
  if (loading)
    return (
      <div className={styles.loadingCharanter}>
        <img src={spinner} alt="loading" />
        <p></p>Loading Character
      </div>
    );
  ...
  if (error)
    return <p className={styles.errorHandle}>Failed to Load Character</p>;
